function out = transfUpdate_2d_marginal(transf0, bi, Y, Sx, coordY, sigma, alpha, rho, coord, K1,K2, logsig, Sig,logAR, SigAR, nsubj,nparts, bnds, parworkers)
...
for i = 1:nsubj
    ...
    if isnan(logliks)
        logliks = posteriorLog(Y, coordY, coord, bi, ncoord, nsubj, nparts, K1, K2, alpha, rho, sigma,Sx, parworkers);
    end
    % scaling X
    ...
    if ScalingX>bnds(1,1) && ScalingX<bnds(1,2)
        ...
        logliks1 = posteriorLog(Y,coordY, coord, bi, ncoord, nsubj, nparts, K1, K2, alpha, rho, sigma,Sx, parworkers);
...
for i=1:nsubj
    ...
    if bCentered(i)>bnds(4,1) && bCentered(i)<bnds(4,2)
        ...
        logliks1 = posteriorLog(Y, coordY, coord, b1, ncoord, nsubj, nparts, K1, K2, alpha, rho, sigma,Sx, parworkers);
        A(i) = min(0, logliks1-logliks+bpropLog-log(bi(i))+log(normpdf(bpropLog, 0, 1))- log(normpdf(log(bi(i)), 0, 1)));
...
if bCentered~=bi
    logliks = posteriorLog(Y, coordY, coord, bCentered, ncoord, nsubj, nparts, K1, K2, alpha, rho, sigma,Sx, parworkers);
end
...
for i=1:nsubj
    ...
    s1(i) = exp(spropLog);
    logliks1 = posteriorLog(Y, coordY, coord, bCentered, ncoord, nsubj, nparts, K1, K2, alpha, rho, s1,Sx, parworkers);
...
if p10*p01~=0
    Sx1 = Sx/alpha*alpha1;
    logliks1 = posteriorLog(Y, coordY, coord, bCentered, ncoord, nsubj, nparts, K1, K2, alpha1, rho, sigma,Sx1, parworkers);
...
if p10*p01~=0
    ...
    logliks1 = posteriorLog(Y, coordY, coord, bCentered, ncoord, nsubj, nparts, K1, K2, alpha, rho1, sigma,Sx1, parworkers);
